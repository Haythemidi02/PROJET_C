...
void ajouter_transaction_carburant(int choix_carburant,FILE*C_fichier) {
    ...
    scanf("%f",&quantitee);
    nouvelle_transaction.quantite = quantitee;
    switch(choix_carburant) {
        case 1: nouvelle_transaction.prix_litre = 2.350;nouvelle_transaction.type ="EssenceSansPlomb" ; break;
        case 2: nouvelle_transaction.prix_litre = 2.220;nouvelle_transaction.type ="Gazoil50" ; break;
        case 3: nouvelle_transaction.prix_litre = 1.950;nouvelle_transaction.type ="Gazoil" ; break;
        case 4: nouvelle_transaction.prix_litre = 0.870;nouvelle_transaction.type ="GPL" ; break;
        case 5: nouvelle_transaction.prix_litre = 1.950;nouvelle_transaction.type ="Mazout" ; break;
    }
    nouvelle_transaction.montant_total = nouvelle_transaction.quantite * nouvelle_transaction.prix_litre;
    fprintf(C_fichier, "%d %s %f %f %f/n",
...
void afficher_transactions_carburant(FILE*C_fichier) {
    ...
    while (fscanf(C_fichier, "%d %s %f %f %f",
                  ...
                  &carburant.montant_total) == 5) {
        printf("| %-15d | %-23s | %-9.2f | %-10.2f | %-14.2f |\n",
               carburant.id_transaction, carburant.type,
               carburant.quantite, carburant.prix_litre,
